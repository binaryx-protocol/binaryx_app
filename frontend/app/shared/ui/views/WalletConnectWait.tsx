...
import hourglassIcon from '../../../../public/shared/wallet/Hourglass.svg'
...
export const WalletConnectWait = (props: Props) => {
  const {connector, onWalletConnectClick, setConnectError, connectError} = props
  const {connect} = useConnect()
  const {address} = useAccount()
  useEffect(() => {
    if (address) onWalletConnectClick(false);
  }, [address])
